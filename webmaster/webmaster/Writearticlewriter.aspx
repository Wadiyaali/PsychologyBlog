<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardWriter.Master" AutoEventWireup="true" CodeBehind="Writearticlewriter.aspx.cs" Inherits="webmaster.WebForm12" %>
        ...
        <div class="add-new-article">
            ...
            <div class="content-wrap">
                    ...
                    <label class="name-field">Title
                        <input type=text size=30 name=title class="light-text" id="txtarticletitlewriter" runat="server">
                    </label>
                    <label class="name-field">Description
                        <textarea name=text rows=8 cols=40 maxlength=2000 class="light-text" id="txtarticlecontentwriter" runat="server"></textarea>
                    </label>
                  <asp:Button ID="btnWrtrticlesubmit" runat="server" Text="Done" CssClass="btn btn-success btn-lg text-white" OnClick="btnWrtrticlesubmit_Click" />
            </div>
        </div>

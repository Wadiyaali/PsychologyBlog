<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardPsychologist.Master" AutoEventWireup="true" CodeBehind="Feedbackpsycho.aspx.cs" Inherits="webmaster.WebForm18" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="wrapper">
        ...
        <fieldset class="section is-active">
          <h3>Your Details</h3>
          <input type="text" name="name" id="txtFeedname" runat="server" placeholder="Name">
          <input type="text" name="email" id="txtFeedEmail" runat="server" placeholder="Email">
      ...
      <label for="super-happy">
        ...
        <fieldset class="section">
          <h3>Your suggestions will help us</h3>
            <textarea id="txtFeed" cols="42" rows="2" required></textarea>
            <asp:TextBox ID="txtRating" runat="server" placeholder="Rate us from 1-5" required="required" ></asp:TextBox>
            
          
   <asp:Button ID="btnWrtFeedsubmit" runat="server" Text="Submit" CssClass="btn submit button" />     </fieldset>

<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardPatient.Master" AutoEventWireup="true" CodeBehind="Writearticlepatient.aspx.cs" Inherits="webmaster.WebForm9" %>
        ...
        <div class="add-new-article">
          ...
          <div class="col-md-12 text-center">  <asp:Label runat="server" ID="msglbl" CssClass="msgr text-danger"></asp:Label>
                    ...
                    <label class="name-field">Title
                        <input type=text size=30 name=title class="light-text" id="txtarticletitlepatient" runat="server" required>
                    </label>
                    <label class="name-field">Description
                        <textarea name=text rows=8 cols=40 class="light-text" maxlength=2000 id="txtarticlecontentpatient" runat="server" required></textarea>
                    </label>
